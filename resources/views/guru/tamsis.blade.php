{{-- filepath: resources/views/guru/tambahsis.blade.php --}}
@extends('layouts.app')

@section('title', 'Tambah Data Siswa')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-red-200 via-orange-200 to-yellow-200 py-12 px-4 flex items-center justify-center ">
    <div class="w-full max-w-2xl">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8 md:p-12">
                <form action="{{ route('guru.storesis') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="transform transition-all duration-200 hover:scale-[1.01]">
                        ...
                        <textarea name="alamat" id="alamat" rows="3"
                            class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200 resize-none">{{ old('alamat') }}</textarea>
                    </div>
